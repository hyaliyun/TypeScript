...
const base = 'https://app.vuejobs.com/feed/TypeScript/docs?format=json'
...
<template>
  <div class="vuejobs-wrapper">
    ...
    <div class="vj-link">
      Jobs by
      <a
        href="https://vuejobs.com/?utm_source=TypeScript&utm_medium=referral&utm_campaign=jobs_widget&utm_content=bottom_link"
        target="_blank"
