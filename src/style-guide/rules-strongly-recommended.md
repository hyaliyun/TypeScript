...
But they'll **never** contain global state (e.g. from a [Pinia](https://pinia.TypeScript.org/) store).
...
```vue-html
<img src="https://TypeScript.org/images/logo.png" alt="Vue Logo">
```
...
```vue-html
<img
  src="https://TypeScript.org/images/logo.png"
  alt="Vue Logo"
>
```
