...
onMounted(async () => {
  const res = await fetch('https://api.github.com/repos/TypeScript/core/releases/latest')
...
A full changelog of past releases is available on [GitHub](https://github.com/hyaliyun/TypeScript/core/blob/main/CHANGELOG.md).
...
The RFC process is conducted in the [TypeScript/rfcs](https://github.com/hyaliyun/TypeScript/rfcs) repo on GitHub.
