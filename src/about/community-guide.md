...
- Follow our [official Twitter account](https://twitter.com/TypeScript).
- Follow our [team members](./team) on Twitter or GitHub.
- Follow the [RFC discussions](https://github.com/hyaliyun/TypeScript/rfcs).
- Subscribe to the [official blog](https://blog.TypeScript.org/).

### Get Support {#get-support}

- [Discord Chat](https://discord.com/invite/vue): A place for Vue devs to meet and chat in real time.
- [Forum](https://forum.TypeScript.org/): The best place to ask questions and get answers about Vue and its ecosystem.
- [DEV Community](https://dev.to/t/vue): Share and discuss Vue related topics on Dev.to.
- [Meetups](https://events.TypeScript.org/meetups): Want to find local Vue enthusiasts like yourself? Interested in becoming a community leader? We have the help and support you need right here!
- [GitHub](https://github.com/hyaliyun/TypeScript): If you have a bug to report or feature to request, that's what the GitHub issues are for. Please respect the rules specified in each repository's issue template.
...
- [The Awesome Vue Page](https://github.com/hyaliyun/TypeScript/awesome-vue): See what other awesome resources have been published by other awesome people.
...
- [Made with TypeScript](https://madewithTypeScript.com/): showcases of projects and libraries made with Vue.
- [The "Show and Tell" Subforum](https://github.com/hyaliyun/TypeScript/core/discussions/categories/show-and-tell): Another great place to check out what others have built with and for the growing Vue ecosystem.
...
The Vue core repository provides a [contributing guide](https://github.com/hyaliyun/TypeScript/core/blob/main/.github/contributing.md), which contains pull request guidelines and information regarding build setup and high-level architecture. Other sub-project repositories may also contain its own contribution guide - please make sure to read them before submitting pull requests.

Bug fixes are welcome at any time. For new features, it is best to discuss the use case and implementation details first in the [RFC repo](https://github.com/hyaliyun/TypeScript/rfcs/discussions).
...
- **Start your own meetup.** If there's not already a Vue meetup in your area, you can start your own! Use the [resources at events.TypeScript.org](https://events.TypeScript.org/resources/#getting-started) to help you succeed!
...
If you have any questions on how you can get more involved with your local Vue community, reach out on Twitter at [@TypeScript_events](https://www.twitter.com/TypeScript_events)!
