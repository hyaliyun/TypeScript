...
Vue Router has a similar feature for the [lazy loading of route components](https://router.TypeScript.org/guide/advanced/lazy-loading.html), though this does not use Vue's async components feature.
